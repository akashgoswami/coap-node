...
var reqHandler = require('./components/reqHandler'),
    ...
    var network = {
        get_active_interface: function (cb) {
            setTimeout(function () {
                cb(null, {
                    ip_address: config.ip || '127.0.0.1',
                    gateway_ip: config.gateway || '192.168.1.1',
                    mac_address: config.mac || '00:00:00:00:00:00'
                });
            }, 1);
        }
    };
 ...
 * CoapNode                                              *
 *********************************************************/
function CoapNode (clientName, smartObj, devAttrs, agent) {
...
CoapNode.prototype._register = function (ip, port, ssid, callback) {
    ...
    var self = this,
        reqObj = {
            ...
            port: port,
            pathname: '/rd',
            payload: helper.checkAndBuildObjList(this, false, { ct: 'application/json', hb: true , obs:true }),
            method: 'POST',
...
CoapNode.prototype.request = function (reqObj, ownAgent, callback) {
    ...
    var self = this,
        agent = ownAgent || this._createAgent(),
...
CoapNode.prototype._createAgent = function () {
    // return external agent if already supplied. 
